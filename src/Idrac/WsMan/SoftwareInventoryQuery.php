...
/**
 * When send this Query Queries the idrac for a inventory of its available and installed firmwares
 */
class SoftwareInventoryQuery extends Request implements DataQuery
{
    ...
    /** @var string */
    protected $resourceUri = 'http://schemas.dmtf.org/wbem/wscim/1/cim-schema/2/DCIM_SoftwareIdentity';

    /** @var array */
    protected $selectorSet = ['__cimnamespace' => 'root/dcim'];
