 ...
 */
class NicEnumerationQuery extends Request implements DataQuery
{
    ...
    /** @var string */
    protected $resourceUri = 'http://schemas.dmtf.org/wbem/wscim/1/cim-schema/2/root/dcim/DCIM_NICEnumeration';
